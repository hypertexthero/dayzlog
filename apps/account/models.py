...
# in models.py - http://www.turnkeylinux.org/blog/django-signals
from django.db.models.signals import post_save
from nomadblog.models import Blog

def create_blog(sender, **kwargs):
    # the object which is saved can be accessed via kwargs 'instance' key.
    obj = kwargs["request", "user","slug", "title", "description"]
    print 'a blog has been created for this user'
    # ...do something else...
...
post_save.connect(create_blog, sender=Account)
