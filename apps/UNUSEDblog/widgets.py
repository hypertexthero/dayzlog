...
from django.forms.widgets import Widget, Select, MultiWidget, SplitDateTimeWidget
from django.forms.extras.widgets import SelectDateWidget

# Custom widgets in order to be able to display created and modified dates as dropdown menus - thanks to Brad Montgomery - http://blog.bradmontgomery.net/about/
# http://bradmontgomery.blogspot.com/2008/11/selecttimewidget-custom-django-widget.html
# http://bradmontgomery.blogspot.com/2008/11/extending-djangos-multiwidget.html
# http://djangosnippets.org/snippets/1206/
